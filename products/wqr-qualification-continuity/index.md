...
<section class="section shell">
  ...
  <div class="screenshot-grid">
    ...
    <figure class="screenshot-card"><a href="{{ '/assets/products/wqr-qualification-continuity/continuity.png' | relative_url }}" target="_blank" rel="noopener"><img src="{{ '/assets/products/wqr-qualification-continuity/continuity.png' | relative_url }}" alt="Welder continuity tracking screen"></a><figcaption>Track process-specific continuity evidence and status.</figcaption></figure>
    <figure class="screenshot-card"><a href="{{ '/assets/products/wqr-qualification-continuity/document-center.png' | relative_url }}" target="_blank" rel="noopener"><img src="{{ '/assets/products/wqr-qualification-continuity/document-center.png' | relative_url }}" alt="WQR document center"></a><figcaption>Keep qualification records and supporting documents organized.</figcaption></figure>
  </div>
</section>
