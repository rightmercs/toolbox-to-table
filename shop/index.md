...
<section class="section shell">
  <div class="section-heading">
    <div><p class="eyebrow"><span></span> Available now</p><h2>Start with the flagship Valve Tool.</h2></div>
  ...
  <div class="product-grid">
    ...
    {% include product-card.html visual="wps" kicker="WELDING" short_title="WPS Review" type="Professional inspection tool" status="In development" title="WPS Review Tool" description="A repeatable workflow for reviewing welding procedures, qualifications, essential variables, and supporting records." feature_1="Structured review sequence" feature_2="Qualification cross-checks" feature_3="Review findings log" %}
