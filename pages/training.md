...
<section class="section shell">
  ...
  <article class="training-feature">
    ...
    <div class="training-feature__body"><p class="edition-label">Version 2.4 · Student and Instructor editions</p><h3>From procedure reading to controlled field review.</h3><p>Includes 15 narrated lessons, captions, transcripts, a detailed student manual, guided workbook, field checklist, practical capstone, 50-question final examination, completion records, and a complete instructor delivery system.</p><ul class="feature-list"><li>15 required sequenced lessons</li><li>10 contact hours</li><li>80% final-exam requirement</li><li>Student and Instructor editions</li></ul><div class="button-row"><a class="button button--primary" href="{{ '/training/wps-interpretation/' | relative_url }}">Explore TTT-WPS-101</a><a class="button text-link" href="https://payhip.com/b/6ZNqO" target="_blank" rel="noopener noreferrer">Enroll — $249.99</a></div></div>
  </article>
</section>
...
<section class="section section--light">
  <div class="shell">
    ...
    <article class="training-feature">
      ...
      <div class="training-feature__body"><p class="edition-label">Commercial Release 1.0 · Individual and Classroom editions</p><h3>From inspection planning to documented closeout.</h3><p>Includes an illustrated 25-page Student Manual, workbook, final examination, field checklist, practical capstone, completion records, and a controlled instructor package.</p><ul class="feature-list"><li>Original shop photographs</li><li>Directional-lighting instruction</li><li>Gauge placement and measurement control</li><li>Surface-condition recognition</li></ul><div class="button-row"><a class="button button--primary" href="{{ '/training/visual-welding-inspection/' | relative_url }}">Explore TTT-VI-101</a><a class="button text-link" href="https://payhip.com/b/z7rfs" target="_blank" rel="noopener noreferrer">Individual — $199.99</a></div></div>
    </article>
  </div>
</section>
